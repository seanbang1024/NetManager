...
- (void)setupInputView
{
    ...
    /** 忘记密码确定按钮点击的通知 */
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(inputViewForgot:) name:@"ZCTradeInputViewForgotButtonClick" object:nil];
}
...
/** 输入框的忘记密码按钮点击 */
- (void)inputViewForgot:(NSNotification *)note
{
...
{
    self.inputView.moneyLbl.text = str;
...
- (void)showInView:(UIView *)view
{
    ...
    /** 输入框起始frame */
    self.inputView.height = ZCScreenWidth * 0.7325;
